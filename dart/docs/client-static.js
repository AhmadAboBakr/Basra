...
$.json = function() {
  return [$.makeLiteralMap(["name", "Kotshena", "types", [$.makeLiteralMap(["name", "Game", "kind", "class", "members", [$.makeLiteralMap(["kind", "method", "name", "collect"]), $.makeLiteralMap(["kind", "method", "noparams", true, "name", "deal"]), $.makeLiteralMap(["kind", "field", "name", "deck"]), $.makeLiteralMap(["kind", "constructor", "noparams", true, "name", "Game"]), $.makeLiteralMap(["kind", "method", "noparams", true, "name", "gameLoop"]), $.makeLiteralMap(["kind", "method", "noparams", true, "name", "initDeck"]), $.makeLiteralMap(["kind", "field", "name", "players"]), $.makeLiteralMap(["kind", "field", "name", "table"])]])]])];
};
